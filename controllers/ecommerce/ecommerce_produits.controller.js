...
const ecommerce_produits = require("../../models/ecommerce/ecommerce_produits.model")
...
const getAllProducts = async (req, res) => {
          try {
                    ...
                    const allProducts = await ecommerce_produits.findproducts(q, category, subCategory, partenaireService, limit, offset)
...
const createProduit = async (req, res) => {
          try {
                    ...
                    const { insertId: ID_PRODUIT } = await ecommerce_produits.createProduit(
                              ID_CATEGORIE_PRODUIT,
