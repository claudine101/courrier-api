...
const createMenu = (ID_REPAS,ID_CATEGORIE_MENU,ID_SOUS_CATEGORIE_MENU,ID_PARTENAIRE_SERVICE,PRIX,IMAGES_1,IMAGES_2,IMAGES_3
) => {
    try {
        var sqlQuery = "INSERT INTO restaurant_menus (ID_REPAS,ID_CATEGORIE_MENU,ID_SOUS_CATEGORIE_MENU,ID_PARTENAIRE_SERVICE,PRIX,IMAGES_1,IMAGES_2,IMAGES_3)";
        sqlQuery += "values (?,?,?,?,?,?,?,?)";
        return query(sqlQuery, [ID_REPAS,ID_CATEGORIE_MENU,ID_SOUS_CATEGORIE_MENU,ID_PARTENAIRE_SERVICE,PRIX,IMAGES_1,IMAGES_2,IMAGES_3])
    }
    catch (error) {
