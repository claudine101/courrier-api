...
productsRouter.put('/updatenote/:ID_NOTE', productsController.changenote)
...
productsRouter.get('/note/liste', productsController.getNoteUser)
productsRouter.delete('/note/:ID_NOTE', productsController.DeleteNote)
productsRouter.post('/note', productsController.insertNote)
productsRouter.get('/note/:ID_PRODUIT', productsController.getnotes)
